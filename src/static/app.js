document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficulty === "") {
        // "All" selected: show only activities with no difficulty specified
        if (details.difficulty) {
          return;
        }
      } else {
        // Specific difficulty selected: show activities with that difficulty,
        // plus activities with no difficulty (they are for all levels)
  ...
  difficultyFilters.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      // Update current difficulty filter and redisplay activities
